...
from cars.models import CarParts, Cars
...
class ServiceHistory(models.Model):
    service = models.ForeignKey(
        Services, on_delete=models.SET_NULL, null=True, related_name="service_log"
    )
...
class BayDetails(models.Model):
    ...
    mechanic_1 = models.ForeignKey(
        Account,
        on_delete=models.SET_NULL,
        related_name="bay_mechanic_1",
        null=True,
        blank=True,
    )
...
class BayCurrentJob(models.Model):
    ...
    mechanic_1 = models.ForeignKey(
        Account,
        on_delete=models.SET_NULL,
        related_name="mechanic_1",
        null=True,
        blank=True,
    )
    mechanic_2 = models.ForeignKey(
        Account,
        on_delete=models.SET_NULL,
        related_name="mechanic_2",
        null=True,
        blank=True,
    )
